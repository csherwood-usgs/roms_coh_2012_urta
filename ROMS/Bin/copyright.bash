#!/bin/bash
#
# svn $Id: copyright.bash 2232 2012-01-03 18:55:20Z arango $
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
search="2002-2011 The ROMS/TOMS"
replace="2002-2012 The ROMS/TOMS"
...
if [ $setsvn -eq 1 ]; then
  svn propset -R copyright '(c) 2002-2012 The ROMS/TOMS Group' Compilers
  svn propset -R copyright '(c) 2002-2012 The ROMS/TOMS Group' Data
  svn propset -R copyright '(c) 2002-2012 The ROMS/TOMS Group' Master
  svn propset -R copyright '(c) 2002-2012 The ROMS/TOMS Group' ROMS
  svn propset -R copyright '(c) 2002-2012 The ROMS/TOMS Group' User
  svn propset copyright '(c) 2002-2012 The ROMS/TOMS Group' . makefile
  svn propset copyright '(c) 2002-2012 The ROMS/TOMS Group' Waves/SWAN/Src/Module.mk
  svn propset copyright '(c) 2002-2012 The ROMS/TOMS Group' Waves/SWAN/Src/waves_coupler.F
else
