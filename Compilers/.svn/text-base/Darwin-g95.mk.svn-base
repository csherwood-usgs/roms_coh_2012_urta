# svn $Id: Linux-g95.mk 2069 2010-05-16 23:46:46Z arango $
#::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::::
...
#
               FC := g95
#           FFLAGS := -fno-second-underscore  -w
           FFLAGS := -fno-second-underscore  -w -funroll-loops -fomit-frame-pointer -malign-double -msse2 -O3
              CPP := /usr/bin/cpp
...
#      HDF5_LIBDIR ?= /opt/g95soft/hdf5/lib
    NETCDF_INCDIR ?= /Users/aretxabaleta/local/netcdf/include
    NETCDF_LIBDIR ?= /Users/aretxabaleta/local/netcdf/lib
      HDF5_LIBDIR ?= /Users/aretxabaleta/local/hdf5/lib
else
...
#    NETCDF_LIBDIR ?= /opt/g95soft/netcdf/lib
    ...
    NETCDF_LIBDIR ?= /Users/aretxabaleta/local/netcdf/lib
             ...
             LIBS := -L$(NETCDF_LIBDIR) -lnetcdf -lcurl
ifdef USE_NETCDF4
